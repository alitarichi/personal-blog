...
const cardData = [
  ...
  },
  {
    ...
    description:
      "Unlock your potential of next-gen smart contracts with our robust and scalable API, tailored for modern blockchain needs",
    color: "cyan",
  },
  {
    ...
    description:
      "Integrate blockchain technology into your projects, with minimal effort and maximum efficiency ",
    color: "violet",
  },
];
            ...
            {cardData.map(({ image, title, description, color }) => (
              ...
              >
                ...
                <div className="flex justify-between mt-12">
                  <TextButton color={color} className="">
                    Learn More
                  </TextButton>
                  <svg
