      ...
      <div className="container">
        ...
        <div className="mt-36">
          <div className="relative z-0 p-8 max-w-xs group">
            <div className="absolute size-16 rounded-xl bg-fuchsia-500 top-1.5 right-1.5 -z-10 blur-lg opacity-0 group-hover:opacity-100 group-hover:bg-fuchsia-400 transition duration-300"></div>
